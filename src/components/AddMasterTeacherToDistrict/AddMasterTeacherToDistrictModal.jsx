...
import './AddMasterTeacherToDistrict.css';
...
const AddTeacherToDistrictModal = ({ isOpen, setIsOpen }) => {
  ...
  return isOpen ? (
    <>
      <div className="add-master-teacher-to-district-modal">
        <div className="add-master-teacher-to-district-modal-top-bar">
          {/* create the title and the x button
          (clicking the x button should set something to false so that the modal doesn't show) */}
          <div className="add-master-teacher-to-district-modal-top-bar-title">
            Add Master Teacher to District
          </div>
          <div className="add-master-teacher-to-district-modal-exit-button">
            <button
              type="button"
              className="add-master-teacher-to-district-exit-button"
              onClick={() => {
                setIsOpen(false);
              }}
            >
        ...
        <div className="add-master-teacher-to-district-modal-body">
          {/* create the form */}
          <div className="add-master-teacher-to-district-modal-field-desc">Area</div>
          <DropdownMenu choices={districts} current={district} setFn={setDistrict} />
          <div className="add-master-teacher-to-district-modal-field-desc">
            Select Master Teacher
          </div>
          <DropdownMenu choices={teachers} current={teacher} setFn={setTeacher} />
          <div className="add-master-teacher-to-district-modal-field-desc">Assign School</div>
          <DropdownMenu choices={schools} current={school} setFn={setSchool} />
        </div>
        <div className="add-master-teacher-to-district-modal-bottom-bar">
          {/* create the save + add another / save buttons */}
          {/* change save function later */}
          <button
            type="button"
            className="add-master-teacher-to-district-modal-save-create-button"
            onClick={() => {
              setIsOpen(false);
            }}
          >
          ...
          <button
            type="button"
            className="add-master-teacher-to-district-modal-save-button"
            onClick={() => {
              setIsOpen(false);
            }}
          >
