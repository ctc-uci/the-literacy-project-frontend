...
import LoginTeacherStartView from './pages/login-master-teachers-start/login-master-teachers-start';
...
import TeachersRemoveTeacherView from './pages/master-teachers-remove-teacher/master-teachers-remove-teacher';
